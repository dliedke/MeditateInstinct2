...
class HeartRateGraphView extends ScreenPicker.ScreenPickerView  {
    ...
    function onUpdate(dc) {    
		...
		// Draw MIN HR text
		dc.drawText(centerX - centerX / 2 - 15, 
					centerY - centerY / 2 + 5, 
					Gfx.FONT_SYSTEM_XTINY, 
					"Min:" + me.summaryModel.minHr.toString(), 
					Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);

		// Draw AVG HR text
		dc.drawText(centerX - centerX / 2 + 37,
					centerY - centerY / 2 + 15,
					Gfx.FONT_SYSTEM_XTINY, 
					"Avg:" + me.summaryModel.avgHr.toString(), 
					Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);

		// Draw MAX HR text
		dc.drawText(centerX + centerX / 2 + 7, 
					centerY - centerY / 2 + 5, 
					Gfx.FONT_SYSTEM_XTINY, 
					"Max:" + me.summaryModel.maxHr.toString(), 
					Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
		...
		//me.summaryModel.maxHr = 90;
		//me.summaryModel.avgHr = 65;
